DECLARE @AccountType_Cash INT;
DECLARE @AccountType_BelloDebit INT;
DECLARE @AccountType_BelloCredit INT;
DECLARE @AccountType_NetCardDebit INT;
DECLARE @AccountType_NetCardCredit INT;
